(function (popper_js, core) {
	...
	/*!
	  * CoreUI PRO  selector-engine.jsv3.3.0 (https://coreui.io)
	  * Copyright 2020 creativeLabs Łukasz Holeczek
	  * License (https://coreui.io/pro/license/)
	  */
	(function (global, factory) {
	...
	/*!
	  * CoreUI PRO  tooltip.jsv3.3.0 (https://coreui.io)
	  * Copyright 2020 creativeLabs Łukasz Holeczek
	  * License (https://coreui.io/pro/license/)
	  */
	(function (global, factory) {
	   module.exports = factory(data, eventHandler, manipulator, core, selectorEngine) ;
